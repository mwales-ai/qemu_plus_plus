...
static const char *local_fs_driver_opts[] = {
...
static const char *synth_fs_driver_opts[] = {
    COMMON_FS_DRIVER_OPTIONS,
    NULL
};
...
static FsDriverTable FsDrivers[] = {
    {
        .name = "local",
        .ops = &local_ops,
        .opts = local_fs_driver_opts,
    },
    {
        .name = "synth",
        .ops = &synth_ops,
        .opts = synth_fs_driver_opts,
    },
};
...
static int validate_opt(void *opaque, const char *name, const char *value,
                        Error **errp)
{
    FsDriverTable *drv = static_cast<FsDriverTable *>(opaque);
    const char **opt;
...
extern "C" int qemu_fsdev_add(QemuOpts *opts, Error **errp)
{
    size_t i;
    ...
    fsle = static_cast<FsDriverListEntry *>(g_malloc0(sizeof(*fsle)));
...
extern "C" FsDriverEntry *get_fsdev_fsentry(char *id)
{
    if (id) {
        struct FsDriverListEntry *fsle;
