...
{
    QemuOpts *opts;
    BDRVNullState *s = static_cast<BDRVNullState *>(bs->opaque);
    int ret = 0;
...
{
    NullAIOCB *acb = static_cast<NullAIOCB *>(opaque);
                                          ...
                                          void *opaque)
{
    ...
    acb = static_cast<NullAIOCB *>(qemu_aio_get(&null_aiocb_info, bs, cb, opaque));
