...
void VHostUserSCSI::classInit(DeviceClass *dc)
{
...
REGISTER_QEMU_DEVICE_IFACES(VHostUserSCSI, TYPE_VHOST_USER_SCSI,
                             TYPE_VHOST_SCSI_COMMON, vhost_user_scsi_interfaces)
