...
{
    return static_cast<GICv3CPUState *>(env->gicv3state);
}
...
static const ARMCPRegInfo gicv3_cpuif_reginfo[] = {
    { .name = "ICC_PMR_EL1",
      .crn = 4, .crm = 6, .opc0 = 3, .opc1 = 0, .opc2 = 0, .state = ARM_CP_STATE_BOTH,
    ...
    { .name = "ICC_IAR0_EL1",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 0, .opc2 = 0, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_R, .accessfn = gicv3_fiq_access,
      .readfn = icc_iar0_read,
    },
    { .name = "ICC_EOIR0_EL1",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 0, .opc2 = 1, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_W, .accessfn = gicv3_fiq_access,
      .writefn = icc_eoir_write,
    },
    { .name = "ICC_HPPIR0_EL1",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 0, .opc2 = 2, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_R, .accessfn = gicv3_fiq_access,
      .readfn = icc_hppir0_read,
    },
    { .name = "ICC_BPR0_EL1",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 0, .opc2 = 3, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
    ...
    { .name = "ICC_AP0R0_EL1",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 0, .opc2 = 4, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_fiq_access,
      .readfn = icc_ap_read,
    ...
    { .name = "ICC_AP1R0_EL1",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 0, .opc2 = 0, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
    ...
    { .name = "ICC_DIR_EL1",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 0, .opc2 = 1, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_W, .accessfn = gicv3_dir_access,
      .writefn = icc_dir_write,
    },
    { .name = "ICC_RPR_EL1",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 0, .opc2 = 3, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_R, .accessfn = gicv3_irqfiq_access,
      .readfn = icc_rpr_read,
    },
    { .name = "ICC_SGI1R_EL1",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 0, .opc2 = 5, .state = ARM_CP_STATE_AA64,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
    ...
    { .name = "ICC_ASGI1R_EL1",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 0, .opc2 = 6, .state = ARM_CP_STATE_AA64,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_W, .accessfn = gicv3_sgi_access,
    ...
    { .name = "ICC_SGI0R_EL1",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 0, .opc2 = 7, .state = ARM_CP_STATE_AA64,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_W, .accessfn = gicv3_sgi_access,
    ...
    { .name = "ICC_IAR1_EL1",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 0, .opc2 = 0, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_R, .accessfn = gicv3_irq_access,
      .readfn = icc_iar1_read,
    },
    { .name = "ICC_EOIR1_EL1",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 0, .opc2 = 1, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_W, .accessfn = gicv3_irq_access,
      .writefn = icc_eoir_write,
    },
    { .name = "ICC_HPPIR1_EL1",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 0, .opc2 = 2, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_R, .accessfn = gicv3_irq_access,
    ...
    { .name = "ICC_BPR1_EL1",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 0, .opc2 = 3, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_irq_access,
      .readfn = icc_bpr_read,
      .writefn = icc_bpr_write,
    ...
    /* This register is banked */
    { .name = "ICC_CTLR_EL1",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 0, .opc2 = 4, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_irqfiq_access,
    ...
    { .name = "ICC_SRE_EL1",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 0, .opc2 = 5, .state = ARM_CP_STATE_BOTH,
    ...
    { .name = "ICC_IGRPEN0_EL1",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 0, .opc2 = 6, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .fgt = FGT_ICC_IGRPENN_EL1,
    ...
    { .name = "ICC_IGRPEN1_EL1",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 0, .opc2 = 7, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .fgt = FGT_ICC_IGRPENN_EL1,
    ...
    { .name = "ICC_SRE_EL2",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 4, .opc2 = 5, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_NO_RAW | ARM_CP_CONST,
      .access = PL2_RW,
      /* We don't support IRQ/FIQ bypass and system registers are
       * always enabled, so all our bits are RAZ/WI or RAO/WI.
    ...
    { .name = "ICC_CTLR_EL3",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 6, .opc2 = 4, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL3_RW,
    ...
    { .name = "ICC_SRE_EL3",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 6, .opc2 = 5, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_NO_RAW | ARM_CP_CONST,
      .access = PL3_RW,
      /* We don't support IRQ/FIQ bypass and system registers are
       * always enabled, so all our bits are RAZ/WI or RAO/WI.
    ...
    { .name = "ICC_IGRPEN1_EL3",
      .crn = 12, .crm = 12, .opc0 = 3, .opc1 = 6, .opc2 = 7, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL3_RW,
...
static const ARMCPRegInfo gicv3_cpuif_icc_apxr1_reginfo[] = {
    { .name = "ICC_AP0R1_EL1",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 0, .opc2 = 5, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_fiq_access,
      .readfn = icc_ap_read,
      .writefn = icc_ap_write,
    ...
    { .name = "ICC_AP1R1_EL1",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 0, .opc2 = 1, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_irq_access,
      .readfn = icc_ap_read,
      .writefn = icc_ap_write,
...
static const ARMCPRegInfo gicv3_cpuif_icc_apxr23_reginfo[] = {
    { .name = "ICC_AP0R2_EL1",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 0, .opc2 = 6, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_fiq_access,
      .readfn = icc_ap_read,
      .writefn = icc_ap_write,
    ...
    { .name = "ICC_AP0R3_EL1",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 0, .opc2 = 7, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_fiq_access,
      .readfn = icc_ap_read,
      .writefn = icc_ap_write,
    ...
    { .name = "ICC_AP1R2_EL1",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 0, .opc2 = 2, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_irq_access,
      .readfn = icc_ap_read,
      .writefn = icc_ap_write,
    ...
    { .name = "ICC_AP1R3_EL1",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 0, .opc2 = 3, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_RW, .accessfn = gicv3_irq_access,
      .readfn = icc_ap_read,
      .writefn = icc_ap_write,
...
static const ARMCPRegInfo gicv3_cpuif_gicv3_nmi_reginfo[] = {
    { .name = "ICC_NMIAR1_EL1",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 0, .opc2 = 5, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL1_R, .accessfn = gicv3_irq_access,
...
static const ARMCPRegInfo gicv3_cpuif_hcr_reginfo[] = {
    { .name = "ICH_AP0R0_EL2",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 4, .opc2 = 0, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
    ...
    { .name = "ICH_AP1R0_EL2",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 4, .opc2 = 0, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
    ...
    { .name = "ICH_HCR_EL2",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 4, .opc2 = 0, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
    ...
    { .name = "ICH_VTR_EL2",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 4, .opc2 = 1, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_R,
      .readfn = ich_vtr_read,
    },
    { .name = "ICH_MISR_EL2",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 4, .opc2 = 2, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_R,
      .readfn = ich_misr_read,
    },
    { .name = "ICH_EISR_EL2",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 4, .opc2 = 3, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_R,
      .readfn = ich_eisr_read,
    },
    { .name = "ICH_ELRSR_EL2",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 4, .opc2 = 5, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_R,
      .readfn = ich_elrsr_read,
    },
    { .name = "ICH_VMCR_EL2",
      .crn = 12, .crm = 11, .opc0 = 3, .opc1 = 4, .opc2 = 7, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
...
static const ARMCPRegInfo gicv3_cpuif_ich_apxr1_reginfo[] = {
    { .name = "ICH_AP0R1_EL2",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 4, .opc2 = 1, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
    ...
    { .name = "ICH_AP1R1_EL2",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 4, .opc2 = 1, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
...
static const ARMCPRegInfo gicv3_cpuif_ich_apxr23_reginfo[] = {
    { .name = "ICH_AP0R2_EL2",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 4, .opc2 = 2, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
    ...
    { .name = "ICH_AP0R3_EL2",
      .crn = 12, .crm = 8, .opc0 = 3, .opc1 = 4, .opc2 = 3, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
    ...
    { .name = "ICH_AP1R2_EL2",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 4, .opc2 = 2, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
    ...
    { .name = "ICH_AP1R3_EL2",
      .crn = 12, .crm = 9, .opc0 = 3, .opc1 = 4, .opc2 = 3, .state = ARM_CP_STATE_BOTH,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_RW,
        ...
        if (arm_feature(&cpu->env, ARM_FEATURE_EL2)) {
            ...
            for (j = 0; j < cs->num_list_regs; j++) {
                ...
                ARMCPRegInfo lr_regset[] = {
                    { .name = "ICH_LRn_EL2",
                      .crn = 12, .crm = static_cast<uint8_t>(12 + (j >> 3)),
                      .opc0 = 3, .opc1 = 4, .opc2 = static_cast<uint8_t>(j & 7),
                      .state = ARM_CP_STATE_BOTH,
                      .type = ARM_CP_IO | ARM_CP_NO_RAW,
                      .access = PL2_RW,
                      .nv2_redirect_offset = static_cast<uint32_t>(0x400 + 8 * j),
                      .readfn = ich_lr_read,
                      .writefn = ich_lr_write,
                    },
                    { .name = "ICH_LRCn_EL2",
                      .cp = 15, .crn = 12,
                      .crm = static_cast<uint8_t>(14 + (j >> 3)),
                      .opc1 = 4, .opc2 = static_cast<uint8_t>(j & 7),
