...
{
    const Property *prop = static_cast<const Property *>(opaque);
    int *ptr = static_cast<int *>(object_field_prop_ptr(obj, prop));
...
{
    uint32_t *p = static_cast<uint32_t *>(object_field_prop_ptr(obj, props));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    uint32_t *p = static_cast<uint32_t *>(object_field_prop_ptr(obj, prop));
...
{
    uint64_t *p = static_cast<uint64_t *>(object_field_prop_ptr(obj, props));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    uint64_t *p = static_cast<uint64_t *>(object_field_prop_ptr(obj, prop));
...
static void prop_get_on_off_auto_bit64(Object *obj, Visitor *v,
                                       ...
                                       Error **errp)
{
    Property *prop = static_cast<Property *>(opaque);
    OnOffAutoBit64 *p = static_cast<OnOffAutoBit64 *>(object_field_prop_ptr(obj, prop));
    OnOffAuto value;
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    bool *ptr = static_cast<bool *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    uint16_t *ptr = static_cast<uint16_t *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    uint32_t *ptr = static_cast<uint32_t *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    int32_t *ptr = static_cast<int32_t *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    uint64_t *ptr = static_cast<uint64_t *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    int64_t *ptr = static_cast<int64_t *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    g_free(*static_cast<char **>(object_field_prop_ptr(obj, prop)));
}
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    char **ptr = static_cast<char **>(object_field_prop_ptr(obj, prop));
                                ...
                                const char *name, char *elem)
{
    Property result = {};
    result.name = name;
    result.info = parent_prop->arrayinfo;
    /*
     ...
     */
    result.offset = (uintptr_t)elem - (uintptr_t)obj;
    return result;
}
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    uint32_t *alenptr = static_cast<uint32_t *>(object_field_prop_ptr(obj, prop));
    void **arrayptr = reinterpret_cast<void **>(reinterpret_cast<char *>(obj) + prop->arrayoffset);
    char *elem = static_cast<char *>(*arrayptr);
    uint32_t i;
                           ...
                           void *opaque, Error **errp)
{
    ...
    while (elem) {
        ...
        elem_prop = array_elem_prop(obj, prop, name, static_cast<char *>(elem->value));
...
out_obj:
    ...
    *arrayptr = g_malloc_n(*alenptr, prop->arrayfieldsize);
    elemptr = static_cast<char *>(*arrayptr);
    for (elem = list; elem; elem = next) {
                           ...
                           void *opaque, Error **errp)
{
    ...
    uint32_t *alenptr = static_cast<uint32_t *>(object_field_prop_ptr(obj, prop));
    void **arrayptr = reinterpret_cast<void **>(reinterpret_cast<char *>(obj) + prop->arrayoffset);
    char *elemptr = static_cast<char *>(*arrayptr);
    ...
    elem = list;
    while (elem) {
        Property elem_prop = array_elem_prop(obj, prop, name, static_cast<char *>(elem->value));
...
static const Property *qdev_prop_find(DeviceState *dev, const char *name)
{
    ...
    do {
        prop = qdev_prop_walk(DEVICE_CLASS(klass), name);
        if (prop) {
            return prop;
        }
                                            ...
                                            const char *name)
{
    ...
    for (i = 0; i < props->len; i++) {
        p = static_cast<const GlobalProperty *>(g_ptr_array_index(props, i));
...
int qdev_prop_check_globals(void)
{
    ...
    for (i = 0; i < global_props()->len; i++) {
        ...
        prop = static_cast<GlobalProperty *>(g_ptr_array_index(global_props(), i));
        if (prop->used) {
            continue;
        }
...
void qdev_alias_all_properties(DeviceState *target, Object *source)
{
    ...
    klass = object_get_class(OBJECT(target));
