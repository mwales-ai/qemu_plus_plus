                      ...
                      Error **errp)
{
    ...
    void **ptr = static_cast<void **>(object_field_prop_ptr(obj, prop));
    const char *value;
    char *p;

    if (*ptr) {
        value = blk_name(static_cast<BlockBackend *>(*ptr));
        if (!*value) {
            BlockDriverState *bs = blk_bs(static_cast<BlockBackend *>(*ptr));
            if (bs) {
                             ...
                             void *opaque, bool iothread, Error **errp)
{
    ...
    if (*ptr) {
        ...
        blk = static_cast<BlockBackend *>(*ptr);
...
static void release_drive(Object *obj, const char *name, void *opaque)
{
    DeviceState *dev = DEVICE(obj);
    const Property *prop = static_cast<const Property *>(opaque);
    BlockBackend **ptr = static_cast<BlockBackend **>(object_field_prop_ptr(obj, prop));
...
static void get_chr(Object *obj, Visitor *v, const char *name, void *opaque,
                    Error **errp)
{
    CharFrontend *fe = static_cast<CharFrontend *>(object_field_prop_ptr(obj, static_cast<const Property *>(opaque)));
    char *p;
                    ...
                    Error **errp)
{
    ERRP_GUARD();
    const Property *prop = static_cast<const Property *>(opaque);
    CharFrontend *fe = static_cast<CharFrontend *>(object_field_prop_ptr(obj, prop));
    Chardev *s;
    char *str;
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    MACAddr *mac = static_cast<MACAddr *>(object_field_prop_ptr(obj, prop));
    char buffer[2 * 6 + 5 + 1];
    char *p = buffer;
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    NICPeers *peers_ptr = static_cast<NICPeers *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    AudioBackend **be = static_cast<AudioBackend **>(object_field_prop_ptr(obj, prop));
...
void qdev_set_nic_properties(DeviceState *dev, NICInfo *nd)
{
    ...
    if (static_cast<uint32_t>(nd->nvectors) != DEV_NVECTORS_UNSPECIFIED &&
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    ReservedRegion *rr = static_cast<ReservedRegion *>(object_field_prop_ptr(obj, prop));
    char buffer[64];
    char *p = buffer;
    int rc;
    ...
    assert((size_t)rc < sizeof(buffer));
                          ...
                          void *opaque, Error **errp)
{
    ...
    int32_t value, *ptr = static_cast<int32_t *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    PCIHostDeviceAddress *addr = static_cast<PCIHostDeviceAddress *>(object_field_prop_ptr(obj, prop));
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    PCIExpLinkSpeed *p = static_cast<PCIExpLinkSpeed *>(object_field_prop_ptr(obj, prop));
    int speed;
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    PCIExpLinkWidth *p = static_cast<PCIExpLinkWidth *>(object_field_prop_ptr(obj, prop));
    int width;
...
{
    const Property *prop = static_cast<const Property *>(opaque);
    QemuUUID *uuid = static_cast<QemuUUID *>(object_field_prop_ptr(obj, prop));
        ...
        const char *name, void *opaque, Error **errp)
{
    IOThreadVirtQueueMappingList **prop_ptr =
        static_cast<IOThreadVirtQueueMappingList **>(object_field_prop_ptr(obj, static_cast<const Property *>(opaque)));
    ...
    const char *name, void *opaque, Error **errp)
{
    VirtIOGPUOutputList **prop_ptr =
        static_cast<VirtIOGPUOutputList **>(object_field_prop_ptr(obj, static_cast<const Property *>(opaque)));
