                             ...
                             void *opaque)
{
    ...
    return (*cpu->cc->sysemu_ops->write_elf32_qemunote)(f, cpu, static_cast<DumpState *>(opaque));
}
                         ...
                         int cpuid, void *opaque)
{
    ...
    return (*cpu->cc->sysemu_ops->write_elf32_note)(f, cpu, cpuid, static_cast<DumpState *>(opaque));
}
                             ...
                             void *opaque)
{
    ...
    return (*cpu->cc->sysemu_ops->write_elf64_qemunote)(f, cpu, static_cast<DumpState *>(opaque));
}
                         ...
                         int cpuid, void *opaque)
{
    ...
    return (*cpu->cc->sysemu_ops->write_elf64_note)(f, cpu, cpuid, static_cast<DumpState *>(opaque));
}
...
{
    if (tcg_enabled()) {
        CPUState *cpu = static_cast<CPUState *>(opaque);
...
static const VMStateField vmstate_cpu_common_exception_index_fields[] = {
...
static const VMStateDescription vmstate_cpu_common_exception_index = {
    ...
    .fields = vmstate_cpu_common_exception_index_fields,
};
...
static const VMStateField vmstate_cpu_common_crash_occurred_fields[] = {
...
static const VMStateDescription vmstate_cpu_common_crash_occurred = {
    ...
    .fields = vmstate_cpu_common_crash_occurred_fields,
};

static const VMStateField vmstate_cpu_common_fields[] = {
    VMSTATE_UINT32(halted, CPUState),
    VMSTATE_UINT32(interrupt_request, CPUState),
    VMSTATE_END_OF_LIST()
};

static const VMStateDescription * const vmstate_cpu_common_subsections[] = {
...
const VMStateDescription vmstate_cpu_common = {
    ...
    .fields = vmstate_cpu_common_fields,
    .subsections = vmstate_cpu_common_subsections,
};
