...
static hwaddr aspeed_soc_ast2400_memmap[ASPEED_DEV_MAX];

static void __attribute__((constructor)) init_aspeed_soc_ast2400_memmap(void)
{
    aspeed_soc_ast2400_memmap[ASPEED_DEV_SPI_BOOT]  = 0x00000000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_IOMEM]  = 0x1E600000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_FMC]    = 0x1E620000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_SPI1]   = 0x1E630000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_EHCI1]  = 0x1E6A1000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_VIC]    = 0x1E6C0000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_SDMC]   = 0x1E6E0000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_SCU]    = 0x1E6E2000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_HACE]   = 0x1E6E3000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_XDMA]   = 0x1E6E7000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_VIDEO]  = 0x1E700000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_ADC]    = 0x1E6E9000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_SRAM]   = 0x1E720000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_SDHCI]  = 0x1E740000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_GPIO]   = 0x1E780000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_RTC]    = 0x1E781000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_TIMER1] = 0x1E782000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_WDT]    = 0x1E785000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_PWM]    = 0x1E786000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_LPC]    = 0x1E789000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_IBT]    = 0x1E789140;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_I2C]    = 0x1E78A000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_PECI]   = 0x1E78B000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_ETH1]   = 0x1E660000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_ETH2]   = 0x1E680000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_UART1]  = 0x1E783000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_UART2]  = 0x1E78D000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_UART3]  = 0x1E78E000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_UART4]  = 0x1E78F000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_UART5]  = 0x1E784000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_VUART]  = 0x1E787000;
    aspeed_soc_ast2400_memmap[ASPEED_DEV_SDRAM]  = 0x40000000;
}

static hwaddr aspeed_soc_ast2500_memmap[ASPEED_DEV_MAX];

static void __attribute__((constructor)) init_aspeed_soc_ast2500_memmap(void)
{
    aspeed_soc_ast2500_memmap[ASPEED_DEV_SPI_BOOT]  = 0x00000000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_IOMEM]  = 0x1E600000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_FMC]    = 0x1E620000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_SPI1]   = 0x1E630000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_SPI2]   = 0x1E631000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_EHCI1]  = 0x1E6A1000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_EHCI2]  = 0x1E6A3000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_VIC]    = 0x1E6C0000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_SDMC]   = 0x1E6E0000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_SCU]    = 0x1E6E2000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_HACE]   = 0x1E6E3000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_XDMA]   = 0x1E6E7000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_ADC]    = 0x1E6E9000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_VIDEO]  = 0x1E700000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_SRAM]   = 0x1E720000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_SDHCI]  = 0x1E740000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_GPIO]   = 0x1E780000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_RTC]    = 0x1E781000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_TIMER1] = 0x1E782000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_WDT]    = 0x1E785000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_PWM]    = 0x1E786000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_LPC]    = 0x1E789000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_IBT]    = 0x1E789140;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_I2C]    = 0x1E78A000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_PECI]   = 0x1E78B000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_ETH1]   = 0x1E660000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_ETH2]   = 0x1E680000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_UART1]  = 0x1E783000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_UART2]  = 0x1E78D000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_UART3]  = 0x1E78E000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_UART4]  = 0x1E78F000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_UART5]  = 0x1E784000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_VUART]  = 0x1E787000;
    aspeed_soc_ast2500_memmap[ASPEED_DEV_SDRAM]  = 0x80000000;
}

static int aspeed_soc_ast2400_irqmap[ASPEED_DEV_MAX];

static void __attribute__((constructor)) init_aspeed_soc_ast2400_irqmap(void)
{
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_UART1]  = 9;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_UART2]  = 32;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_UART3]  = 33;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_UART4]  = 34;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_UART5]  = 10;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_VUART]  = 8;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_FMC]    = 19;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_EHCI1]  = 5;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_EHCI2]  = 13;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_SDMC]   = 0;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_SCU]    = 21;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_ADC]    = 31;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_GPIO]   = 20;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_RTC]    = 22;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_TIMER1] = 16;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_TIMER2] = 17;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_TIMER3] = 18;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_TIMER4] = 35;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_TIMER5] = 36;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_TIMER6] = 37;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_TIMER7] = 38;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_TIMER8] = 39;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_WDT]    = 27;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_PWM]    = 28;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_LPC]    = 8;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_I2C]    = 12;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_PECI]   = 15;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_ETH1]   = 2;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_ETH2]   = 3;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_XDMA]   = 6;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_SDHCI]  = 26;
    aspeed_soc_ast2400_irqmap[ASPEED_DEV_HACE]   = 4;
}
...
static void aspeed_ast2400_soc_init(Object *obj)
{
    ...
    object_initialize_child(obj, "sdc", &s->sdhci, type_name);
