...
static void sonorapass_bmc_i2c_init(AspeedMachineState *bmc)
{
    ...
    /* bus 4 : */
    uint8_t *eeprom4_54 = static_cast<uint8_t *>(g_malloc0(8 * 1024));
    ...
    /* bus 8 : */
    uint8_t *eeprom8_56 = static_cast<uint8_t *>(g_malloc0(8 * 1024));
...
REGISTER_QEMU_OBJECT_CLASS_ONLY_IFACES(aspeed_sonorapass,
