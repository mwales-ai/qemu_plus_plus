...
static hwaddr aspeed_soc_ast2600_memmap[ASPEED_DEV_MAX];

static void __attribute__((constructor)) init_aspeed_soc_ast2600_memmap(void)
{
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SPI_BOOT]  = 0x00000000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SRAM]      = 0x10000000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_DPMCU]     = 0x18000000;
    /* 0x16000000     0x17FFFFFF : AHB BUS do LPC Bus bridge */
    aspeed_soc_ast2600_memmap[ASPEED_DEV_IOMEM]     = 0x1E600000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_PWM]       = 0x1E610000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_FMC]       = 0x1E620000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SPI1]      = 0x1E630000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SPI2]      = 0x1E631000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_EHCI1]     = 0x1E6A1000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_EHCI2]     = 0x1E6A3000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_MII1]      = 0x1E650000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_MII2]      = 0x1E650008;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_MII3]      = 0x1E650010;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_MII4]      = 0x1E650018;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_ETH1]      = 0x1E660000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_ETH3]      = 0x1E670000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_ETH2]      = 0x1E680000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_ETH4]      = 0x1E690000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_VIC]       = 0x1E6C0000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_HACE]      = 0x1E6D0000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SDMC]      = 0x1E6E0000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SCU]       = 0x1E6E2000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_XDMA]      = 0x1E6E7000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_ADC]       = 0x1E6E9000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_DP]        = 0x1E6EB000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_PCIE_PHY1] = 0x1E6ED200;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SBC]       = 0x1E6F2000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_EMMC_BC]   = 0x1E6f5000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_VIDEO]     = 0x1E700000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SDHCI]     = 0x1E740000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_EMMC]      = 0x1E750000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_PCIE0]     = 0x1E770000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_GPIO]      = 0x1E780000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_GPIO_1_8V] = 0x1E780800;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_RTC]       = 0x1E781000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_TIMER1]    = 0x1E782000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_WDT]       = 0x1E785000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_LPC]       = 0x1E789000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_IBT]       = 0x1E789140;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_I2C]       = 0x1E78A000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_PECI]      = 0x1E78B000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART1]     = 0x1E783000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART2]     = 0x1E78D000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART3]     = 0x1E78E000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART4]     = 0x1E78F000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART5]     = 0x1E784000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART6]     = 0x1E790000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART7]     = 0x1E790100;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART8]     = 0x1E790200;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART9]     = 0x1E790300;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART10]    = 0x1E790400;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART11]    = 0x1E790500;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART12]    = 0x1E790600;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_UART13]    = 0x1E790700;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_VUART]     = 0x1E787000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_FSI1]      = 0x1E79B000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_FSI2]      = 0x1E79B100;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_I3C]       = 0x1E7A0000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_PCIE_MMIO1] = 0x70000000;
    aspeed_soc_ast2600_memmap[ASPEED_DEV_SDRAM]     = 0x80000000;
}
...
static int aspeed_soc_ast2600_irqmap[ASPEED_DEV_MAX];

static void __attribute__((constructor)) init_aspeed_soc_ast2600_irqmap(void)
{
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART1]     = 47;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART2]     = 48;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART3]     = 49;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART4]     = 50;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART5]     = 8;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART6]     = 57;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART7]     = 58;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART8]     = 59;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART9]     = 60;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART10]    = 61;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART11]    = 62;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART12]    = 63;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_UART13]    = 64;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_VUART]     = 8;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_FMC]       = 39;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_SDMC]      = 0;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_SCU]       = 12;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_ADC]       = 78;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_XDMA]      = 6;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_SDHCI]     = 43;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_EHCI1]     = 5;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_EHCI2]     = 9;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_EMMC]      = 15;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_GPIO]      = 40;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_GPIO_1_8V] = 11;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_RTC]       = 13;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_TIMER1]    = 16;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_TIMER2]    = 17;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_TIMER3]    = 18;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_TIMER4]    = 19;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_TIMER5]    = 20;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_TIMER6]    = 21;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_TIMER7]    = 22;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_TIMER8]    = 23;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_WDT]       = 24;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_PWM]       = 44;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_LPC]       = 35;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_IBT]       = 143;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_I2C]       = 110;   /* 110 -> 125 */
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_PCIE0]     = 168;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_PECI]      = 38;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_ETH1]      = 2;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_ETH2]      = 3;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_HACE]      = 4;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_ETH3]      = 32;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_ETH4]      = 33;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_KCS]       = 138;   /* 138 -> 142 */
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_DP]        = 62;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_FSI1]      = 100;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_FSI2]      = 101;
    aspeed_soc_ast2600_irqmap[ASPEED_DEV_I3C]       = 102;   /* 102 -> 107 */
}
...
static void aspeed_soc_ast2600_init(Object *obj)
{
    ...
    for (i = 0; i < static_cast<int>(sc->num_cpus); i++) {
