...
static void supermicrox11_bmc_i2c_init(AspeedMachineState *bmc)
{
    ...
    DeviceState *dev;
    uint8_t *eeprom_buf = static_cast<uint8_t *>(g_malloc0(32 * 1024));
...
REGISTER_QEMU_OBJECT_CLASS_ONLY_IFACES(aspeed_supermicrox11,
                                        MACHINE_TYPE_NAME("supermicrox11-bmc"),
                                        TYPE_ASPEED_MACHINE,
                                        aspeed_machine_supermicrox11_bmc_class_init,
