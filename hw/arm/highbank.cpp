...
{
    uint32_t *regs = static_cast<uint32_t *>(opaque);
...
REGISTER_QEMU_OBJECT_CLASS_ONLY_IFACES(highbank_machine,
                                        MACHINE_TYPE_NAME("highbank"),
                                        TYPE_MACHINE,
                                        HighbankMachine::classInit,
                                        arm_machine_interfaces)

REGISTER_QEMU_OBJECT_CLASS_ONLY_IFACES(midway_machine,
                                        MACHINE_TYPE_NAME("midway"),
                                        TYPE_MACHINE,
                                        MidwayMachine::classInit,
                                        arm_machine_interfaces)
