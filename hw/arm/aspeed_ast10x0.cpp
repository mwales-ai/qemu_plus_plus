...
static hwaddr aspeed_soc_ast1030_memmap[ASPEED_DEV_MAX];

static void __attribute__((constructor)) init_aspeed_soc_ast1030_memmap(void)
{
    aspeed_soc_ast1030_memmap[ASPEED_DEV_SRAM]      = 0x00000000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_SECSRAM]   = 0x79000000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_IOMEM]     = 0x7E600000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_PWM]       = 0x7E610000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_FMC]       = 0x7E620000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_SPI1]      = 0x7E630000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_SPI2]      = 0x7E640000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UDC]       = 0x7E6A2000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_HACE]      = 0x7E6D0000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_SCU]       = 0x7E6E2000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_JTAG0]     = 0x7E6E4000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_JTAG1]     = 0x7E6E4100;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_ADC]       = 0x7E6E9000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_ESPI]      = 0x7E6EE000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_SBC]       = 0x7E6F2000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_GPIO]      = 0x7E780000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_SGPIOM]    = 0x7E780500;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_TIMER1]    = 0x7E782000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART1]     = 0x7E783000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART2]     = 0x7E78D000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART3]     = 0x7E78E000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART4]     = 0x7E78F000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART5]     = 0x7E784000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART6]     = 0x7E790000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART7]     = 0x7E790100;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART8]     = 0x7E790200;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART9]     = 0x7E790300;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART10]    = 0x7E790400;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART11]    = 0x7E790500;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART12]    = 0x7E790600;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_UART13]    = 0x7E790700;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_WDT]       = 0x7E785000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_LPC]       = 0x7E789000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_PECI]      = 0x7E78B000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_I3C]       = 0x7E7A0000;
    aspeed_soc_ast1030_memmap[ASPEED_DEV_I2C]       = 0x7E7B0000;
}

static int aspeed_soc_ast1030_irqmap[ASPEED_DEV_MAX];

static void __attribute__((constructor)) init_aspeed_soc_ast1030_irqmap(void)
{
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART1]     = 47;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART2]     = 48;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART3]     = 49;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART4]     = 50;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART5]     = 8;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART6]     = 57;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART7]     = 58;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART8]     = 59;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART9]     = 60;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART10]    = 61;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART11]    = 62;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART12]    = 63;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UART13]    = 64;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_GPIO]      = 11;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_TIMER1]    = 16;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_TIMER2]    = 17;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_TIMER3]    = 18;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_TIMER4]    = 19;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_TIMER5]    = 20;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_TIMER6]    = 21;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_TIMER7]    = 22;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_TIMER8]    = 23;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_WDT]       = 24;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_LPC]       = 35;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_PECI]      = 38;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_FMC]       = 39;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_ESPI]      = 42;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_PWM]       = 44;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_ADC]       = 46;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_SPI1]      = 65;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_SPI2]      = 66;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_I3C]       = 102; /* 102 -> 105 */
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_I2C]       = 110; /* 110 ~ 123 */
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_KCS]       = 138; /* 138 -> 142 */
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_UDC]       = 9;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_SGPIOM]    = 51;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_JTAG0]     = 27;
    aspeed_soc_ast1030_irqmap[ASPEED_DEV_JTAG1]     = 53;
}
