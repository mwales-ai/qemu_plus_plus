...
static const hwaddr *aspeed_soc_ast27x0ssp_memmap = []() -> const hwaddr * {
    static hwaddr a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_UART0]     =  0x74C33000;
    a[ASPEED_DEV_UART1]     =  0x74C33100;
    a[ASPEED_DEV_UART2]     =  0x74C33200;
    a[ASPEED_DEV_UART3]     =  0x74C33300;
    a[ASPEED_DEV_UART4]     =  0x72C1A000;
    a[ASPEED_DEV_UART5]     =  0x74C33400;
    a[ASPEED_DEV_UART6]     =  0x74C33500;
    a[ASPEED_DEV_UART7]     =  0x74C33600;
    a[ASPEED_DEV_UART8]     =  0x74C33700;
    a[ASPEED_DEV_UART9]     =  0x74C33800;
    a[ASPEED_DEV_UART10]    =  0x74C33900;
    a[ASPEED_DEV_UART11]    =  0x74C33A00;
    a[ASPEED_DEV_UART12]    =  0x74C33B00;
    a[ASPEED_DEV_INTC]      =  0x72100000;
    a[ASPEED_DEV_INTCIO]    =  0x74C18000;
    a[ASPEED_DEV_SCU]       =  0x72C02000;
    a[ASPEED_DEV_SRAM]      =  0x70000000;
    a[ASPEED_DEV_TIMER1]    =  0x72C10000;
    a[ASPEED_DEV_SDRAM]     =  0x00000000;
    a[ASPEED_DEV_SCUIO]     =  0x74C02000;
    a[ASPEED_DEV_IPC0]      =  0x72C1C000;
    a[ASPEED_DEV_IPC1]      =  0x74C39000;
    return a;
}();

static const int *aspeed_soc_ast27x0ssp_irqmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_UART0]     = 164;
    a[ASPEED_DEV_UART1]     = 164;
    a[ASPEED_DEV_UART2]     = 164;
    a[ASPEED_DEV_UART3]     = 164;
    a[ASPEED_DEV_UART4]     = 8;
    a[ASPEED_DEV_UART5]     = 164;
    a[ASPEED_DEV_UART6]     = 164;
    a[ASPEED_DEV_UART7]     = 164;
    a[ASPEED_DEV_UART8]     = 164;
    a[ASPEED_DEV_UART9]     = 164;
    a[ASPEED_DEV_UART10]    = 164;
    a[ASPEED_DEV_UART11]    = 164;
    a[ASPEED_DEV_UART12]    = 164;
    a[ASPEED_DEV_SCU]       = 12;
    a[ASPEED_DEV_TIMER1]    = 16;
    return a;
}();

/* SSPINT 164 */
static const int *ast2700_ssp132_ssp164_intcmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_UART0]     = 7;
    a[ASPEED_DEV_UART1]     = 8;
    a[ASPEED_DEV_UART2]     = 9;
    a[ASPEED_DEV_UART3]     = 10;
    a[ASPEED_DEV_UART5]     = 11;  /* UART4 skipped */
    a[ASPEED_DEV_UART6]     = 12;
    a[ASPEED_DEV_UART7]     = 13;
    a[ASPEED_DEV_UART8]     = 14;
    a[ASPEED_DEV_UART9]     = 15;
    a[ASPEED_DEV_UART10]    = 16;
    a[ASPEED_DEV_UART11]    = 17;
    a[ASPEED_DEV_UART12]    = 18;
    return a;
}();
...
REGISTER_QEMU_OBJECT_INIT_CLASS_SIZED_NOCS(aspeed_soc_ast27x0ssp,
                                            Aspeed27x0CoprocessorState,
                                            TYPE_ASPEED27X0SSP_COPROCESSOR,
                                            TYPE_ASPEED_COPROCESSOR,
                                            aspeed_soc_ast27x0ssp_init,
                                            aspeed_soc_ast27x0ssp_class_init)
