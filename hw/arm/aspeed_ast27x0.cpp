...
static const hwaddr *aspeed_soc_ast2700_memmap = []() -> const hwaddr * {
    static hwaddr a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_VBOOTROM]  =  0x00000000;
    a[ASPEED_DEV_SPI_BOOT]  =  0x100000000;
    a[ASPEED_DEV_IOMEM]     =  0x00020000;
    a[ASPEED_DEV_IOMEM0]    =  0x12000000;
    a[ASPEED_DEV_IOMEM1]    =  0x14000000;
    a[ASPEED_DEV_LTPI]      =  0x30000000;
    a[ASPEED_DEV_UART0]     =  0x14C33000;
    a[ASPEED_DEV_UART1]     =  0x14C33100;
    a[ASPEED_DEV_UART2]     =  0x14C33200;
    a[ASPEED_DEV_UART3]     =  0x14C33300;
    a[ASPEED_DEV_UART4]     =  0x12C1A000;
    a[ASPEED_DEV_UART5]     =  0x14C33400;
    a[ASPEED_DEV_UART6]     =  0x14C33500;
    a[ASPEED_DEV_UART7]     =  0x14C33600;
    a[ASPEED_DEV_UART8]     =  0x14C33700;
    a[ASPEED_DEV_UART9]     =  0x14C33800;
    a[ASPEED_DEV_UART10]    =  0x14C33900;
    a[ASPEED_DEV_UART11]    =  0x14C33A00;
    a[ASPEED_DEV_UART12]    =  0x14C33B00;
    a[ASPEED_DEV_VUART]     =  0x14C30000;
    a[ASPEED_DEV_FMC]       =  0x14000000;
    a[ASPEED_DEV_SPI0]      =  0x14010000;
    a[ASPEED_DEV_SPI1]      =  0x14020000;
    a[ASPEED_DEV_SPI2]      =  0x14030000;
    a[ASPEED_DEV_EHCI1]     =  0x12061000;
    a[ASPEED_DEV_EHCI2]     =  0x12063000;
    a[ASPEED_DEV_EHCI3]     =  0x14121000;
    a[ASPEED_DEV_EHCI4]     =  0x14123000;
    a[ASPEED_DEV_INTC]      =  0x12100000;
    a[ASPEED_DEV_INTCIO]    =  0x14C18000;
    a[ASPEED_DEV_SDMC]      =  0x12C00000;
    a[ASPEED_DEV_SCU]       =  0x12C02000;
    a[ASPEED_DEV_ADC]       =  0x14C00000;
    a[ASPEED_DEV_SRAM]      =  0x10000000;
    a[ASPEED_DEV_SDHCI]     =  0x14080000;
    a[ASPEED_DEV_GPIO]      =  0x14C0B000;
    a[ASPEED_DEV_RTC]       =  0x12C0F000;
    a[ASPEED_DEV_TIMER1]    =  0x12C10000;
    a[ASPEED_DEV_WDT]       =  0x14C37000;
    a[ASPEED_DEV_I2C]       =  0x14C0F000;
    a[ASPEED_DEV_PCIE0]     =  0x120E0000;
    a[ASPEED_DEV_PCIE1]     =  0x120F0000;
    a[ASPEED_DEV_PCIE2]     =  0x140D0000;
    a[ASPEED_DEV_PCIE_PHY0] =  0x12C15000;
    a[ASPEED_DEV_PCIE_PHY1] =  0x12C15800;
    a[ASPEED_DEV_PCIE_PHY2] =  0x14C1C000;
    a[ASPEED_DEV_PCIE_MMIO0] = 0x60000000;
    a[ASPEED_DEV_PCIE_MMIO1] = 0x80000000;
    a[ASPEED_DEV_PCIE_MMIO2] = 0xA0000000;
    a[ASPEED_DEV_ETH1]      =  0x14050000;
    a[ASPEED_DEV_ETH2]      =  0x14060000;
    a[ASPEED_DEV_ETH3]      =  0x14070000;
    a[ASPEED_DEV_MII1]      =  0x14040000;
    a[ASPEED_DEV_MII2]      =  0x14040008;
    a[ASPEED_DEV_MII3]      =  0x14040010;
    a[ASPEED_DEV_SDRAM]     =  0x400000000;
    a[ASPEED_DEV_EMMC]      =  0x12090000;
    a[ASPEED_DEV_HACE]      =  0x12070000;
    a[ASPEED_DEV_DPMCU]     =  0x11000000;
    a[ASPEED_DEV_SCUIO]     =  0x14C02000;
    a[ASPEED_DEV_SLI]       =  0x12C17000;
    a[ASPEED_DEV_SLIIO]     =  0x14C1E000;
    a[ASPEED_GIC_DIST]      =  0x12200000;
    a[ASPEED_GIC_REDIST]    =  0x12280000;
    return a;
}();
...
static const int *aspeed_soc_ast2700a0_irqmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_UART0]     = 132;  a[ASPEED_DEV_UART1]     = 132;
    a[ASPEED_DEV_UART2]     = 132;  a[ASPEED_DEV_UART3]     = 132;
    a[ASPEED_DEV_UART4]     = 8;    a[ASPEED_DEV_UART5]     = 132;
    a[ASPEED_DEV_UART6]     = 132;  a[ASPEED_DEV_UART7]     = 132;
    a[ASPEED_DEV_UART8]     = 132;  a[ASPEED_DEV_UART9]     = 132;
    a[ASPEED_DEV_UART10]    = 132;  a[ASPEED_DEV_UART11]    = 132;
    a[ASPEED_DEV_UART12]    = 132;  a[ASPEED_DEV_FMC]       = 131;
    a[ASPEED_DEV_EHCI1]     = 33;   a[ASPEED_DEV_EHCI2]     = 37;
    a[ASPEED_DEV_SDMC]      = 0;    a[ASPEED_DEV_SCU]       = 12;
    a[ASPEED_DEV_ADC]       = 130;  a[ASPEED_DEV_SDHCI]     = 133;
    a[ASPEED_DEV_GPIO]      = 130;  a[ASPEED_DEV_RTC]       = 13;
    a[ASPEED_DEV_TIMER1]    = 16;   a[ASPEED_DEV_TIMER2]    = 17;
    a[ASPEED_DEV_TIMER3]    = 18;   a[ASPEED_DEV_TIMER4]    = 19;
    a[ASPEED_DEV_TIMER5]    = 20;   a[ASPEED_DEV_TIMER6]    = 21;
    a[ASPEED_DEV_TIMER7]    = 22;   a[ASPEED_DEV_TIMER8]    = 23;
    a[ASPEED_DEV_WDT]       = 131;  a[ASPEED_DEV_PWM]       = 131;
    a[ASPEED_DEV_LPC]       = 128;  a[ASPEED_DEV_IBT]       = 128;
    a[ASPEED_DEV_I2C]       = 130;  a[ASPEED_DEV_PECI]      = 133;
    a[ASPEED_DEV_ETH1]      = 132;  a[ASPEED_DEV_ETH2]      = 132;
    a[ASPEED_DEV_ETH3]      = 132;  a[ASPEED_DEV_XDMA]      = 5;
    a[ASPEED_DEV_EMMC]      = 15;   a[ASPEED_DEV_KCS]       = 128;
    a[ASPEED_DEV_HACE]      = 4;    a[ASPEED_DEV_DP]        = 28;
    a[ASPEED_DEV_I3C]       = 131;
    return a;
}();

static const int *aspeed_soc_ast2700a1_irqmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_UART0]     = 196;  a[ASPEED_DEV_UART1]     = 196;
    a[ASPEED_DEV_UART2]     = 196;  a[ASPEED_DEV_UART3]     = 196;
    a[ASPEED_DEV_UART4]     = 8;    a[ASPEED_DEV_UART5]     = 196;
    a[ASPEED_DEV_UART6]     = 196;  a[ASPEED_DEV_UART7]     = 196;
    a[ASPEED_DEV_UART8]     = 196;  a[ASPEED_DEV_UART9]     = 196;
    a[ASPEED_DEV_UART10]    = 196;  a[ASPEED_DEV_UART11]    = 196;
    a[ASPEED_DEV_UART12]    = 196;  a[ASPEED_DEV_FMC]       = 195;
    a[ASPEED_DEV_EHCI1]     = 33;   a[ASPEED_DEV_EHCI2]     = 37;
    a[ASPEED_DEV_EHCI3]     = 196;  a[ASPEED_DEV_EHCI4]     = 196;
    a[ASPEED_DEV_SDMC]      = 0;    a[ASPEED_DEV_SCU]       = 12;
    a[ASPEED_DEV_ADC]       = 194;  a[ASPEED_DEV_SDHCI]     = 197;
    a[ASPEED_DEV_GPIO]      = 194;  a[ASPEED_DEV_RTC]       = 13;
    a[ASPEED_DEV_TIMER1]    = 16;   a[ASPEED_DEV_TIMER2]    = 17;
    a[ASPEED_DEV_TIMER3]    = 18;   a[ASPEED_DEV_TIMER4]    = 19;
    a[ASPEED_DEV_TIMER5]    = 20;   a[ASPEED_DEV_TIMER6]    = 21;
    a[ASPEED_DEV_TIMER7]    = 22;   a[ASPEED_DEV_TIMER8]    = 23;
    a[ASPEED_DEV_WDT]       = 195;  a[ASPEED_DEV_PWM]       = 195;
    a[ASPEED_DEV_LPC]       = 192;  a[ASPEED_DEV_IBT]       = 192;
    a[ASPEED_DEV_I2C]       = 194;  a[ASPEED_DEV_PCIE0]     = 56;
    a[ASPEED_DEV_PCIE1]     = 57;   a[ASPEED_DEV_PCIE2]     = 196;
    a[ASPEED_DEV_PECI]      = 197;  a[ASPEED_DEV_ETH1]      = 196;
    a[ASPEED_DEV_ETH2]      = 196;  a[ASPEED_DEV_ETH3]      = 196;
    a[ASPEED_DEV_XDMA]      = 5;    a[ASPEED_DEV_EMMC]      = 15;
    a[ASPEED_DEV_KCS]       = 192;  a[ASPEED_DEV_HACE]      = 4;
    a[ASPEED_DEV_DP]        = 28;   a[ASPEED_DEV_I3C]       = 195;
    return a;
}();

/* GICINT 128 */
/* GICINT 192 */
static const int *ast2700_gic128_gic192_intcmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_LPC]       = 0;
    a[ASPEED_DEV_IBT]       = 2;
    a[ASPEED_DEV_KCS]       = 4;
...
/* GICINT 130 */
/* GICINT 194 */
static const int *ast2700_gic130_gic194_intcmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_ADC]        = 16;
    a[ASPEED_DEV_GPIO]       = 18;
    a[ASPEED_DEV_I2C]        = 0;
    return a;
}();
...
/* GICINT 131 */
/* GICINT 195 */
static const int *ast2700_gic131_gic195_intcmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_FMC]       = 25;
    a[ASPEED_DEV_WDT]       = 16;
    a[ASPEED_DEV_PWM]       = 29;
...
/* GICINT 132 */
/* GICINT 196 */
static const int *ast2700_gic132_gic196_intcmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_UART0]     = 7;  a[ASPEED_DEV_UART1]     = 8;
    a[ASPEED_DEV_UART2]     = 9;  a[ASPEED_DEV_UART3]     = 10;
    a[ASPEED_DEV_UART5]     = 11; a[ASPEED_DEV_UART6]     = 12;
    a[ASPEED_DEV_UART7]     = 13; a[ASPEED_DEV_UART8]     = 14;
    a[ASPEED_DEV_UART9]     = 15; a[ASPEED_DEV_UART10]    = 16;
    a[ASPEED_DEV_UART11]    = 17; a[ASPEED_DEV_UART12]    = 18;
    a[ASPEED_DEV_EHCI3]     = 28; a[ASPEED_DEV_EHCI4]     = 29;
    a[ASPEED_DEV_PCIE2]     = 31;
    a[ASPEED_DEV_ETH1]      = 0;  a[ASPEED_DEV_ETH2]      = 1;
    a[ASPEED_DEV_ETH3]      = 2;
    return a;
}();
...
/* GICINT 133 */
/* GICINT 197 */
static const int *ast2700_gic133_gic197_intcmap = []() -> const int * {
    static int a[ASPEED_DEV_IPC1 + 1] = {};
    a[ASPEED_DEV_SDHCI]     = 1;
    a[ASPEED_DEV_PECI]      = 4;
    return a;
}();
...
static void aspeed_soc_ast2700_init(Object *obj)
{
    ...
    for (i = 0; i < sc->spis_num; i++) {
        snprintf(type_name, sizeof(type_name), "aspeed.spi%d-%s", i, socname);
    ...
    for (i = 0; i < sc->pcie_num; i++) {
        snprintf(type_name, sizeof(type_name), "aspeed.pcie-phy-%s", socname);
        object_initialize_child(obj, "pcie-phy[*]", &s->pcie_phy[i], type_name);
        object_property_set_int(OBJECT(&s->pcie_phy[i]), "id", i, &error_abort);

        snprintf(type_name, sizeof(type_name), "aspeed.pcie-cfg-%s", socname);
        object_initialize_child(obj, "pcie-cfg[*]", &s->pcie[i], type_name);
...
static bool aspeed_soc_ast2700_gic_realize(DeviceState *dev, Error **errp)
{
    ...
    for (i = 0; i < sc->num_cpus; i++) {
        ...
        /* Indexed by GTIMER_PHYS(0), GTIMER_VIRT(1), GTIMER_HYP(2), GTIMER_SEC(3) */
        const int timer_irq[4] = {
