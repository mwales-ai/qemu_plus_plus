                   ...
                   Error **errp)
{
    ...
    int ret;
    const gnutls_datum_t gkey = { (unsigned char *)key, (unsigned int)nkey };
    const gnutls_datum_t gsalt = { (unsigned char *)salt, (unsigned int)nsalt };
    ...
    ret = gnutls_pbkdf2(static_cast<gnutls_mac_algorithm_t>(hash_map[hash]),
                        &gkey,
                        &gsalt,
                        iterations,
                        out,
